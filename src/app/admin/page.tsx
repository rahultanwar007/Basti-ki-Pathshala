    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div className="text-center">
          <div className="animate-spin h-12 w-12 border-4 border-blue-500 border-t-transparent rounded-full mx-auto mb-4" aria-label="Loading spinner" />
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center flex-wrap gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-gray-800 mt-1">Admin Dashboard</h1>
          ...
          <div className="text-center">
            ...
            <button onClick={handleLogout} className="mt-2 text-sm text-red-600 hover:text-red-800">Logout</button>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {volunteers.length === 0 ? (
          <div className="text-center py-12">
            <div className="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
            ...
            <Link href="/register" className="inline-flex px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm font-medium">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="hidden sm:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Address</th>
                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Registered</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {volunteers.map((v) => (
                    <tr key={v._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-900">{v.contactNo}</td>
                      <td className="hidden sm:table-cell px-6 py-4 text-sm text-gray-900 truncate max-w-xs" title={v.address}>
                        {v.address}
                      </td>
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
          <Link href="/register" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm font-medium">
            Add New Volunteer
          </Link>
          <button
